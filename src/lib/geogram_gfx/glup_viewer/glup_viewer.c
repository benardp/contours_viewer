...
GLdouble* glup_viewer_get_saved_modelview_matrix() {
    glup_viewer_assert(transform_saved == GL_TRUE);
    return modelview_save;
}

GLdouble* glup_viewer_get_saved_projection_matrix() {
    glup_viewer_assert(transform_saved == GL_TRUE);
    return project_save;
}
